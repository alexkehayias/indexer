...
async fn chat_handler(
    ...
    let (note_search_tool, searx_search_tool, email_unread_tool, openai_api_hostname, openai_api_key, openai_model) = {
    ...
    chat(&tools, &mut transcript, &mut accum_new, &openai_api_hostname, &openai_api_key, &openai_model).await;
